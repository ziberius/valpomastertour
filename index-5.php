...
<html lang="en">
    <head>
        ...
        <!--[if lt IE 8]>
                        <div style='text-align:center'><a href="httpa://www.microsoft.com/windows/internet-explorer/default.aspx?ocid=ie6_countdown_bannercode"><img src="http://www.theie6countdown.com/images/upgrade.jpg"border="0"alt=""/></a></div>
                <![endif]-->    

        <!--[if lt IE 9]>
          <script src="httpa://html5shim.googlecode.com/svn/trunk/html5.js"></script>
        ...
        <div id="main">
            ...
            <div id="slider_wrapper">
                ...
                <div class="slider_bot">
                    <div class="page_title">Servicio de Transporte</div>
                    <div class="breadcrumbs1">
                        <div class="breadcrumbs1_inner"><a href="index.php">Inicio</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;Servicio de Transporte</div>	
                    </div>
                </div>
            </div>
                                ...
                                <div class="span4">
                                    <div class="thumb1">
                                        <div class="thumbnail clearfix">
                                            <figure class="img-polaroid"><img src="http://via.placeholder.com/130x124" alt=""></figure>
                                            <div class="caption">
                                                <p>
                                                    <strong>Lorem ipsum dolor sit amet conse ctetur </strong>
                                                </p>
                                                <p>
                                                    abore et dolore magna. Ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod 
                                                </p>			
                                                <a href="#" class="button1">Detalle</a>
                                            </div>
                                        </div>
                                    </div>	
                                </div>
