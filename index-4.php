...
<header><div class="logo_wrapper log"><a href="index.php" class="logo"><img src="images/logo.png" alt=""></a></div></header>
			...
			<div class="navbar-inner navbar-inner_">
				...
				<div class="nav-collapse nav-collapse_ collapse">
					<ul class="nav sf-menu clearfix">
						...
						<li><a href="index-2.php">hot tours</a></li>
						<li><a href="index-3.php">destinations</a></li>
						<li class="sub-menu sub-menu-1 active"><a href="#">Pages <i class="fa fa-angle-down" aria-hidden="true"></i></a>
							<ul>
								<li><a href="index-4.php">Gallery</a></li>
								<li><a href="index-5.php">Services</a></li>
						...
						<li class="sub-menu sub-menu-1"><a href="#">Blog <i class="fa fa-angle-down" aria-hidden="true"></i></a>
							<ul>
								...
								<li><a href="blog-post.php">Blog Poast</a></li>
...
<div class="breadcrumbs1_inner"><a href="index.php">Home Page</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;Gallery</div>	
</div>
</div>
</div>
		...
		<div class="thumb-isotope">
			<div class="thumbnail clearfix">
				<a href="images/blank.png">
					<figure>
						<img src="http://via.placeholder.com/270x270" alt=""><em></em>
					</figure>
					<div class="caption">
						<div class="txt1">UAE</div>							
						<div class="txt2">Abore et dolore magna. Ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut </div>
					</div>
				</a>				
			</div>
		</div>
		...
		<div class="thumb-isotope">
			<div class="thumbnail clearfix">
				<a href="images/blank.png">
					...
					<div class="caption">
						<div class="txt1">San Francisco</div>							
						<div class="txt2">Abore et dolore magna. Ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut </div>
					</div>
				</a>				
			</div>
		...
		<div class="thumb-isotope">
			<div class="thumbnail clearfix">
				<a href="images/blank.png">
					...
					<div class="caption">
						<div class="txt1">Cockermouth</div>							
						<div class="txt2">Abore et dolore magna. Ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut </div>
					</div>
				</a>				
			</div>
		...
		<div class="thumb-isotope">
			<div class="thumbnail clearfix">
				<a href="images/blank.png">
					...
					<div class="caption">
						<div class="txt1">Costa Daurada</div>							
						<div class="txt2">Abore et dolore magna. Ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut </div>
					</div>
				</a>				
			</div>
		...
		<div class="thumb-isotope">
			<div class="thumbnail clearfix">
				<a href="images/blank.png">
					...
					<div class="caption">
						<div class="txt1">Aquae Sulis</div>							
						<div class="txt2">Abore et dolore magna. Ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut </div>
					</div>
				</a>				
			</div>
...
<div class="row">
<div class="span12">
<div class="copyright">Copyright   © 2017 Travel Guide. All rights reserved.&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;<a href="#">Privacy Policy</a>&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;<a href="#">Terms of Use</a>&nbsp;</div>
</div>	
</div>	
</div>	
</footer>
