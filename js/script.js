var general = {
    elementos: {
        "todo": [
            {id: "#menuInicio", tipo: "text"},
            {id: "#menuTour", tipo: "text"},
            {id: "#menuContacto", tipo: "text"},
            {id: "#footerRRSSTitulo", tipo: "text"},
            {id: ".btnCerrar", tipo: "text"}
        ],
        "tours.php": [
            {id: "#tourDesc1", tipo: "text"},
            {id: "#tourDesc2", tipo: "text"},
            {id: "#cpcReservar", tipo: "text"},
            {id: "#bcInicio", tipo: "text"},
            {id: "#bcTour", tipo: "text"},
            {id: "#tituloTour", tipo: "text"},
            {id: "#modalReservar > div > h3", tipo: "text"},
            {id: "#labelInputEmail", tipo: "text"},
            {id: "#labelInputFecha", tipo: "text"},
            {id: "#inputEmail", tipo: "placeholder"},
            {id: "#inputFechaTour", tipo: "placeholder"}
        ],
        "index.php": [
            {id: "#destinosTitulo", tipo: "text"},
            {id: "#introTextoTitulo", tipo: "text"},
            {id: "#introTexto1", tipo: "text"},
            {id: "#introTexto2", tipo: "text"}
        ],
        "contacto.php": [
            {id: "#pageTitleDiv", tipo: "text"},
            {id: "#bcInicio", tipo: "text"},
            {id: "#bcContacto", tipo: "text"},
            {id: "#h1DatosContacto", tipo: "text"},
            {id: "#spanTelefono", tipo: "text"},
            {id: "#h2FormularioContacto", tipo: "text"},
            {id: "#lbNombreCompleto", tipo: "text"},
            {id: "#lbTuEmail", tipo: "text"},
            {id: "#lbTelefono", tipo: "text"},
            {id: "#lbMensaje", tipo: "text"},
            {id: "#btnEnviar", tipo: "text"},
            {id: "#h2Testimonios", tipo: "text"}
        ]
    },
    traducciones: {
        en: {
            ...
            "index.php": {
                ...
                "#introTexto1": "Greetings! My name is Osvaldo, founder and manager of Valparaiso Master Tour, i have travelled this good earth for over fifteen years in the very heart of the tourism industry, discovering diverse cultures and  immersed in this enthusiastic business shoulder to shoulder with people from all around the globe.",
            ...
            "contacto.php": {
                "#pageTitleDiv": "Contact us",
                "#bcInicio": "Home",
                "#bcContacto": "Contact us",
                "#h1DatosContacto": "Contact Information",
                "#spanTelefono": "Phone",
                "#h2FormularioContacto": "Contact Form",
                "#lbNombreCompleto": "Full Name:",
                "#lbTuEmail": "Your Email:",
                "#lbTelefono": "Phone:",
                "#lbMensaje": "Message:",
                "#btnEnviar": "Send",
                "#h2Testimonios": "Testimonies"
            }
        ...
        es: {
            "tours.php": {
                ...
                "#labelInputEmail": "Email",
                "#labelInputFecha": "Fecha",
                "#inputEmail": "Email",
                "#inputFechaTour": "Fecha"
            },
            "todo": {
                "#menuInicio": "Inicio",
                "#menuTour": "Tour",
            ...
            "contacto.php": {
                "#pageTitleDiv": "Contacto",
                "#bcInicio": "Inicio",
                "#bcContacto": "Contacto",
                "#h1DatosContacto": "Datos de Contacto",
                "#spanTelefono": "Teléfono",
                "#h2FormularioContacto": "Formulario de Contacto",
                "#lbNombreCompleto": "Nombre Completo:",
                "#lbTuEmail": "Tu email:",
                "#lbTelefono": "Teléfono:",
                "#lbMensaje": "Mensaje:",
                "#btnEnviar": "Enviar",
                "#h2Testimonios": "Testimonios"
            }
    ...
    setearTextos: function () {
        ...
        general.elementos.todo.forEach(function (item, index) {
            $(item.id).hide(function () {
                if (item.tipo === "text") {
                    $(this).text(general.traducciones[idioma].todo[item.id]);
                }
                if (item.tipo === "placeholder") {
                    $(this).attr("placeholder", general.traducciones[idioma].todo[item.id]);
                }
                $(this).slideDown();
            });
        });
        ...
        general.elementos[pagina].forEach(function (item, index) {
            $(item.id).hide(function () {
                if (item.tipo === "text") {
                    $(this).text(general.traducciones[idioma][pagina][item.id]);
                }
                if (item.tipo === "placeholder") {
                    $(this).attr("placeholder", general.traducciones[idioma][pagina][item.id]);
                }
                $(this).slideDown();
            });
        });
